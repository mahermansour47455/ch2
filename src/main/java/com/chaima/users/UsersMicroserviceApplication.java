...
public class UsersMicroserviceApplication {
	...
	UserService userService;
	 @PostConstruct
		/*
		 * void init_users() { //ajouter les rôles userService.addRole(new
		 * Role(null,"ADMIN")); userService.addRole(new Role(null,"USER")); //ajouter
		 * les users userService.saveUser(new User(null,"admin","123",true,null));
		 * userService.saveUser(new User(null,"chaima","123",true,null));
		 * userService.saveUser(new User(null,"yosri","123",true,null)); //ajouter les
		 * rôles aux users userService.addRoleToUser("admin", "ADMIN");
		 * userService.addRoleToUser("admin", "USER");
		 * userService.addRoleToUser("chaima", "USER");
		 * userService.addRoleToUser("yosri", "USER"); }
		 */
	@Bean
